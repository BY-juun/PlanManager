...
import { SUBMIT_PLAN_FAILURE, SUBMIT_PLAN_REQUEST, SUBMIT_PLAN_SUCCESS, SUBMIT_TIME_FAILURE, SUBMIT_TIME_REQUEST, SUBMIT_TIME_SUCCESS } from "../reducers/plan";
...
export default function* planSaga() {
  yield all([fork(watchSubmitPlan), fork(watchSubmitTIme)]);
}
